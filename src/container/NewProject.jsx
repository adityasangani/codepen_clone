          ...
          <div className="flex items-center justify-center gap-6">
            ...
            <div className="flex flex-col items-start justify-start">
              ...
              <div className="flex items-center justify-center px-3 -mt-2 gap-2">
                ...
                <motion.p
                  whileTap={{ scale: 0.9 }}
                  className="text-[12px] bg-emerald-500 rounded-lg px-2 py-[1px] text-white font-semibold cursor-pointer"
                >
                  + Follow
                </motion.p>
              </div>
          ...
          {user && (
            <div className="flex items-center justify-center gap-4">
              <motion.button
                onClick={saveProgram}
                whileTap={{ scale: 0.9 }}
                className="px-4 py-2 bg-emerald-500 cursor-pointer text-base text-primary font-semibold rounded-lg "
              >
